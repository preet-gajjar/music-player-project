...
def get_album_cover():
    ...
    global label1
    label1 = tkinter.Label(album_frame, image=load)
    label1.image = load
...
#create volume label frame
album_frame= customtkinter.CTkFrame(master=master_frame, width=170, height=170, bg_color='#aab0b5', fg_color='#aab0b5')
